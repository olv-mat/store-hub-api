...
export class CreatingTables1770291712299 implements MigrationInterface {
    name = 'CreatingTables1770291712299'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."products_category_enum" AS ENUM('Clothing', 'Perfumery', 'Sneakers', 'Accessories')`);
