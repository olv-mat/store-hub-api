...
export class CreatingTables1770293636069 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."users_role_enum" AS ENUM('Admin', 'Owner')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."stores_category_enum" AS ENUM('Clothing', 'Perfumery', 'Sneakers', 'Accessories')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_59f9237ea1f716dcebf39abea9" ON "stores" ("state", "city", "neighborhood") `,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."products_category_enum" AS ENUM('Shirts', 'Pants', 'Dresses', 'Jackets', 'Fragrances', 'Skincare', 'Makeup', 'Casual Shoes', 'Sport Shoes', 'Boots', 'Watches', 'Jewelry', 'Bags', 'Belts')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_594ca159cc17128d062999845f" ON "products" ("in_stock") `,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_594ca159cc17128d062999845f"`,
    );
    await queryRunner.query(`DROP TABLE "products"`);
    await queryRunner.query(`DROP TYPE "public"."products_category_enum"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_59f9237ea1f716dcebf39abea9"`,
    );
